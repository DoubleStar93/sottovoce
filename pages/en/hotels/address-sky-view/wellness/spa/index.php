  ...
  <div class="row no-gutters h-100 align-items-center  px-4 px-lg-0 pl-lg-5">
    <div class="col-12 col-lg-8 header-banner-img-content-box pl-lg-5">
      ...
      <div class="spa-cta mt-5 col-md-4 col-12">
                  ...
                  <a href="javascript:void(0);" class="transparent-btn d-block mt-3 btn-reserve-unique" target="_self">
    ...
    <div class="row justify-content-between no-gutters">
      <div class="col-md-6 col-12 spa-left-section">
        ...
        <div class="row my-3 justify-content-md-start justify-content-center">
          <div class="col-lg-6 col-md-6 col-12">
                          <a href="javascript:void(0);" target="_self" class="btn primary-btn btn-reserve-unique">
                Reserve Your Treatment              </a>
                      </div>
        </div>
      </div>
